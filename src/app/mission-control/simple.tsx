...
export default function MissionControlSimple() {
  ...
  const [selectedLoja, setSelectedLoja] = useState('e5915ba4-fdb4-4fa7-b9d5-c71d3c704c55')
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Marque para iniciar, clique em finalizar quando concluir</p>
        <Button 
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      <h3 className={`font-semibold ${mission.status === 'concluida' ? 'line-through' : ''}`}>
                        {mission.titulo || mission.template_titulo || 'Missão'}
                      </h3>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                      ...
                      <span className="flex items-center">
                        ...
                        {mission.prazo_vencimento ? new Date(mission.prazo_vencimento).toLocaleDateString() : 'Hoje'}
                      </span>
                      {mission.categoria && (
